...
The initial encoding of light at the retina is but the first in a series of visual transformations: The stimulus incident at the cornea is transformed into an image at the retina. The retinal image is transformed into a neural response by the light sensitive elements of the eye, the photoreceptors. The photoreceptor responses are transformed to a neural response on the optic nerve. The optic nerve representation is transformed into a cortical representation, and so forth. We can approximate certain important aspects of these transformations, and thus an approximation of the early encoding of light by the visual pathways, using linear systems theory. Because all of our visual experience is limited by the image formation within our eye, we begin by describing this transformation of the light signal and we will use this analysis as an introduction to linear methods.

For many years, human optics were characterized using classical experimental methods based on lenses, beam splitters, and mirrors - and those methods are the focus of the first edition of this book. Since the late 1990s an important new set of experimental technologies,  based on **adaptive optics**, has enabled much better measurements of the properties of eye.  These methods are also being used to make entirely new measurements of the cells in the retina, and they are used to deliver precisely defined stimuli to the retina for perceptual measurements. We describe the adaptive optics technology in a new section (@sec-adaptive-optics), and we update the measurements of the optical quality of the eye (@sec-optical-quality).
...
![Diffraction: Diffraction pattern caused by a circular aperture. (a) The image of a diffraction pattern measured through a circular aperture. (b) A graph of the cross-sectional intensity of the diffraction pattern. (After Goodman, 1968).](/wp-content/uploads/2012/02/diffraction.png){#fig-diffraction width="50%"}
...
![Astigmatism: Astigmatism implies an asymmetric point spread function. The point spread shown here is narrow in one direction and wide in another. The spatial resolution of an astigmatic system is better in the narrow direction than the wide direction.](/wp-content/uploads/2012/02/astigmatism.png){#fig-astigmatism width="70%"}
