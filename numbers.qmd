...
3.  Typical ambient luminance levels (in cd m\sup{-2}): starlight $10^{-3}$; moonlight $10^{-1}$; indoor lighting $10^{2}$; sunlight $10^{5}$; max intensity of common CRT monitors, $10^{2}$
4.  One Troland (Td) of retinal illumination is produced on the retina when the eye looks at a surface of 1 cd / $m^{2}$ through a pupil of area 1~mm\sup{2}.
